package com.tech.cryptotracker.crypto.presentation.coin_detail
...
import com.tech.cryptotracker.R
import com.tech.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
...
import com.tech.cryptotracker.crypto.presentation.models.toDisplayableNumber
import com.tech.cryptotracker.ui.theme.CryptoTrackerTheme
import com.tech.cryptotracker.ui.theme.greenBackground
        ...
        Column(
            ...
            FlowRow(
                ...
                InfoCard(
                    ...
                    formattedText = "$ ${coin.marketCapUsed.formatted}",
                ...
                InfoCard(
                    title = stringResource(R.string.change_24h), formattedText = absoluteChangeFormatted.formatted,
                    icon = if(isPositive){
